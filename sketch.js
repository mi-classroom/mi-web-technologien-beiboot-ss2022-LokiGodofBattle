...
function setup() {
  ...
  if (typeof params.page == 'undefined'){
	redirect_by_post(getURL()+"?page=0", {'user': 'cranach', 'password': 'meisterwerke'}, false);
  }
...
function gotolink() {
	redirect_by_post(getURL().split("?")[0]+"?page=" + (int(params.page)+1), {'user': 'cranach', 'password': 'meisterwerke'}, false);
}
